    ...
    >
      <Popover className="relative flex items-center">
        <PopoverButton className="focus:outline-none flex items-center cursor-pointer group py-2">
          <LocalizedClientLink
            href="/account"
            className={`text-[13px] font-bold uppercase tracking-wider text-[#111111] transition-colors duration-200 border-b border-transparent ${isOpen ? 'border-[#111111] pb-[1px]' : 'hover:text-[#555555]'}`}
